...
run_system_checks() {
    ...
    unset BURROW_SECURITY_FIXES_SHOWN
    unset BURROW_SECURITY_FIXES_SKIPPED
    echo ""
    ...
    if [[ "${BURROW_SECURITY_FIXES_SKIPPED:-}" != "true" ]]; then
        echo ""
    fi
...
main() {
    ...
    export BURROW_CURRENT_COMMAND="optimize"
