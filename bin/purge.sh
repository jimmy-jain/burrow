...
start_purge() {
    ...
    export BURROW_CURRENT_COMMAND="purge"
...
# Show help message
show_help() {
    echo -e "${PURPLE_BOLD}Burrow Purge${NC}, Clean old project build artifacts"
    echo ""
    echo -e "${YELLOW}Usage:${NC} bw purge [options]"
    echo ""
    ...
    for arg in "$@"; do
        case "$arg" in
            ...
            *)
                ...
                echo "Use 'bw purge --help' for usage information"
                exit 1
                ;;
        esac
    done
