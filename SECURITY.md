...
Burrow is a local system maintenance tool. It includes high-risk operations such as cleanup, uninstall, optimization, and artifact removal. We treat safety boundaries, deletion logic, and release integrity as security-sensitive areas.

## Reporting a Vulnerability

Please report suspected security issues privately.

- Open a [GitHub Security Advisory](https://github.com/jimmy-jain/burrow/security/advisories/new)
- Subject line: `Burrow security report`
...
- Burrow version and install method
- macOS version
...
- False negatives where Burrow refuses to clean something
...
## Security-Focused Areas in Burrow
