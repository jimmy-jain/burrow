...
show_clean_help() {
    ...
    echo "  --all, -a         Run all cleanup sections without interactive selection"
...
show_installer_help() {
    echo "Usage: bw installer [OPTIONS]"
    echo ""
...
show_optimize_help() {
    echo "Usage: bw optimize [OPTIONS]"
    echo ""
...
show_uninstall_help() {
    echo "Usage: bw uninstall [OPTIONS]"
    echo ""
